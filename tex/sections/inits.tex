...
If you look in the run directory of \refsection{sec:inputs-core-ciaf} (\dirname{EXP02} there), as well as the output files previously listed, you will see several files with names beginning \filename{ORCA2_00008760_restart} (assuming the run completed).
