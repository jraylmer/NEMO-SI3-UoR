...
Section~\ref{sec:forcings} describes how to use multi-year atmospheric forcing with either the CORE or \mbox{JRA-55-do} forcing datasets, and section~\ref{sec:restarts} explains how to use restart files to continue a new simulation from a previous one.
Updated explanations of how to replace the full ocean model with the standalone surface scheme (SAS) or mixed-layer model, and how to manage and use custom modifications to the source, will be added back to this document later.
