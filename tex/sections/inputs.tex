...
\begin{itemize}
    ...
    \item \textbf{Mixing coefficients}: \filename{eddy_viscosity_3D.nc} provides spatially-varying lateral mixing coefficients; see section~10.3 of the \citetalias{nemo-manual}.
