...
The instructions in this document have been tested with the 5.0.2 release, although they are likely to work with the main branch or earlier 5.x versions as well.
...
It is also possible to clone the repository at a different point in its history at the first step; for example, to clone the repository at the point corresponding to release version 5.0.2 into a directory called \verb|nemo_5.0.2|:
