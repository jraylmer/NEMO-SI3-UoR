...
For XIOS this was done automatically via the extra configuration file \verb|arch-RACC2.env|; NEMO does not have such an interface with its compilation script so we must do it manually:
